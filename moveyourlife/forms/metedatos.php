...
if ($usuario == "simedejas" && $password == "TeLaMeto!") {
	...
	$tomail="contacto@solucionatusproblemas.es";
	$asunto="¡Atención! Intento de introducir datos en la web";
	$mensaje = "Se ha introducido un nombre de usuario y contraseña erróneo en la web. Mira a ver si alguien quiere tocar los cojones.";
	mail($tomail,$asunto,utf8_decode($mensaje));
}
